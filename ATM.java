	...
	protected void buildApp(){
		...
		withDraw1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 5){
					balance = balance - 5;
					displayArea.setText("<html>Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn $");
					updateTransactionHist("User Has Withdrawn $");
				} else {
					displayArea.setText("<html> Your Balance is below $. Unable to Withdraw!! <br><br>" 
		...
		deposit.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
					displayArea.setText("<html> Deposit Selected! <br> Please input an amout below or equal to $ and click enter! <br><br>" 
					+ finishedTransaction() + "</html>" );
					readyToEnter = true;
			}	
		});
